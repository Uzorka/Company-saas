...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0000_schema_migrations') then
  raise notice 'already applied, skipping: %', '0000_schema_migrations';
else
...
insert into schema_migrations (version) values ('0000_schema_migrations');
raise notice 'applied: %', '0000_schema_migrations';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0029_audit_creates') then
  raise notice 'already applied, skipping: %', '0029_audit_creates';
else
...
insert into schema_migrations (version) values ('0029_audit_creates');
raise notice 'applied: %', '0029_audit_creates';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0030_settings_scope') then
  raise notice 'already applied, skipping: %', '0030_settings_scope';
else
...
insert into schema_migrations (version) values ('0030_settings_scope');
raise notice 'applied: %', '0030_settings_scope';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0031_reports') then
  raise notice 'already applied, skipping: %', '0031_reports';
else
...
insert into schema_migrations (version) values ('0031_reports');
raise notice 'applied: %', '0031_reports';
end if;
end
$mig$;

-- ---------------------------------------------------------------------------
-- 0032_public_form_rate_limit
-- ---------------------------------------------------------------------------
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0032_public_form_rate_limit') then
  raise notice 'already applied, skipping: %', '0032_public_form_rate_limit';
else
...
insert into schema_migrations (version) values ('0032_public_form_rate_limit');
raise notice 'applied: %', '0032_public_form_rate_limit';
end if;
end
$mig$;

-- ---------------------------------------------------------------------------
-- 0033_high_risk_grants
-- ---------------------------------------------------------------------------
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0033_high_risk_grants') then
  raise notice 'already applied, skipping: %', '0033_high_risk_grants';
else
...
insert into schema_migrations (version) values ('0033_high_risk_grants');
raise notice 'applied: %', '0033_high_risk_grants';
end if;
end
$mig$;

-- ---------------------------------------------------------------------------
-- 0034_hiring_pipeline
-- ---------------------------------------------------------------------------
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0034_hiring_pipeline') then
  raise notice 'already applied, skipping: %', '0034_hiring_pipeline';
else
...
insert into schema_migrations (version) values ('0034_hiring_pipeline');
raise notice 'applied: %', '0034_hiring_pipeline';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0035_email_settings') then
  raise notice 'already applied, skipping: %', '0035_email_settings';
else
...
insert into schema_migrations (version) values ('0035_email_settings');
raise notice 'applied: %', '0035_email_settings';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0036_messaging') then
  raise notice 'already applied, skipping: %', '0036_messaging';
else
...
insert into schema_migrations (version) values ('0036_messaging');
raise notice 'applied: %', '0036_messaging';
end if;
end
$mig$;
...
do $mig$
begin
if exists (select 1 from schema_migrations where version = '0037_messaging_rich') then
  raise notice 'already applied, skipping: %', '0037_messaging_rich';
else
...
insert into schema_migrations (version) values ('0037_messaging_rich');
raise notice 'applied: %', '0037_messaging_rich';
end if;
end
$mig$;
